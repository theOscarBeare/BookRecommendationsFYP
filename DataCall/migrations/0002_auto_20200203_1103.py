# Generated by Django 3.0.3 on 2020-02-03 11:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookisbn', models.IntegerField(blank=True, db_column='BookISBN', null=True)),
                ('bookname', models.CharField(blank=True, db_column='BookName', max_length=50, null=True)),
                ('noofpages', models.CharField(blank=True, db_column='NoOfPages', max_length=50, null=True)),
            ],
            options={
                'db_table': 'Books',
                'managed': False,
