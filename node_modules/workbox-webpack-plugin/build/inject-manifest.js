...
class InjectManifest {
  ...
  async handleMake(compilation, parentCompiler) {
    ...
    const childCompiler = compilation.createChildCompiler(this.constructor.name, outputOptions, this.config.webpackCompilationPlugins);
  ...
  async handleEmit(compilation) {
    ...
    const manifestEntries = await getManifestEntriesFromCompilation(compilation, config); // See https://github.com/GoogleChrome/workbox/issues/2263
